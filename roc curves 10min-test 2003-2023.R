...
postscript("ROC_2003-2023_3models.eps",paper="special",width=7.5*1.15/1.2/3*4,
...
workspaces<-c(
  "results ten-minute glm 2003-2023 nlag 1 thr 18.RData",
  "results ten-minute glm 2003-2023 nlag 1 thr 42.RData",
  "results ten-minute glm 2003-2023 nlag 1 thr 66.RData",
  "results ten-minute glm 2003-2023 nlag 1 thr 90.RData")
...
works<-c(
  "results ten-minute bart 2003-2023 nlag 1 thr 18.RData",
  "results ten-minute bart 2003-2023 nlag 1 thr 42.RData",
  "results ten-minute bart 2003-2023 nlag 1 thr 66.RData",
  "results ten-minute bart 2003-2023 nlag 1 thr 90.RData")
...
load("results ten-minute gev 2003-2023 lag1.RData")
