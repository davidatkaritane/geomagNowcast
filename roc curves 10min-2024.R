...
postscript("ROC_2024_3models.eps",paper="special",width=7.5*1.15/1.2/3*4,
...
workspaces<-c(
  "results 1 hour glm 2024 nlag 1 thr 18.RData",
  "results 1 hour glm 2024 nlag 1 thr 42.RData",
  "results 1 hour glm 2024 nlag 1 thr 66.RData",
  "results 1 hour glm 2024 nlag 1 thr 90.RData")



#p.thr<-seq(0,1,length.out=10^4+1)
p.thr<-seq(0,1,length.out=10^3+1)
...
works<-c(
  "results ten-minute bart 2024 nlag 1 thr 18.RData",
  "results ten-minute bart 2024 nlag 1 thr 42.RData",
  "results ten-minute bart 2024 nlag 1 thr 66.RData",
  "results ten-minute bart 2024 nlag 1 thr 90.RData")
...
load("results ten-minute gev 2024 lag1.RData")

r<-d.test$r[(1+nlag):n.test]
