...
load("../Data/twohourly data.RData")

nlags<-c(1) #c(1,2,3)
#r.thrs<-c(25,50,100)
r.thrs<-c(18, 42, 66, 90, 150)

years.train<-1994:2023
years.test<-2024
...
system.time({
  ...
  for(nlag in nlags){
    ...
    for(r.thr in r.thrs){
      ...
      save.image(paste0("results 2 hour bart 2024 nlag ",nlag," thr ",r.thr,".RData"))
...
#Time difference of 1.233891 hours
